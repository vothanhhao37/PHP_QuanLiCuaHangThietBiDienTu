...
$sql = 'select Ma_khach_hang,Ten_khach_hang,Phai,Dia_chi,Email,Dien_thoai from khach_hang';
...
echo "<p align='center'><font size='5' color='blue'> THÔNG TIN SỮA</font></P>";
 ...
 {	 $stt=1;
	...
	{          echo "<tr>";
		     ...
		     if($rows[2]=="1")
             echo "<td><img src='../img/man.jpg' width=40px alt=''></td>";
      else
      echo "<td><img src='../img/female.jpg' width=40px alt='lỗi'></td>";
             echo "<td>$rows[3]</td>";
             echo "<td>$rows[4]</td>";
             echo "<td>$rows[5]</td>";
		     echo "</tr>";
