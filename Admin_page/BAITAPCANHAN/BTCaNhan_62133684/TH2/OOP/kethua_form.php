        ...
        <fieldset>
            ...
            <table border='0'>
                <tr>
                    <td>Chọn hình</td>
                    <td>
                        <input type="radio" name="hinh" value="hv" <?php if (isset($_POST['hinh']) && ($_POST['hinh']) == "hv")
                ...
                <tr>
                <td>Cạnh b</td>
                   <td><input type="text" name="canhb" value="<?php if (isset($_POST['canhb']))
                        echo $_POST['canhb']; ?>" /></td>
                </tr>
                <td>Cạnh c</td>
                   <td><input type="text" name="canhc" value="<?php if (isset($_POST['canhb']))
                        echo $_POST['canhb']; ?>" /></td>
                </tr>
                <tr>
                    <td>Kết quả:</td>
